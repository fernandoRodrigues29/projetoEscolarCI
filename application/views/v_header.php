            ...
            <ul class="nav navbar-nav">
             ...
             <!--
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo base_url('public/img/users/'.$img_usuario)?>" class="user-image" alt="User Image"/>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small><?php echo $email_usuario."-".date('m-d');?></small>
                    </p>
                  </li>
                  <!-- Menu Body --
                  <li class="user-body">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo base_url('index.php/c_login/sair')?>" class="btn btn-danger btn-flat">Sair</a>
                    </div>
                  </li>
                </ul>
              </li>
